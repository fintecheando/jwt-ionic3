...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__book_edit_page__ = __webpack_require__(471);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_books_service__ = __webpack_require__(218);
...
var BookEditPage = (function (_super) {
    ...
    function BookEditPage(navCtrl, navParams, menuCtrl, storage, formBuilder, booksService) {
        ...
        _this.bookData = _this.formBuilder.group({
            title: [_this.book.title, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].required],
            author_name: [_this.book.author_name, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].required],
            pages_count: [_this.book.pages_count, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].required],
        });
        return _this;
    }
