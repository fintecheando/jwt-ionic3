...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile_page__ = __webpack_require__(312);
...
ProfilePage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-profile-page',template:/*ion-inline-start:"/home/afiliamedica/dev/ionic3-seed-jwt/src/pages/profile-page/profile-page.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>    \n    <ion-title>{{ \'page.profile\' | translate }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-card *ngIf="user">\n    \n    <ion-row>\n      <ion-col col-25>{{ \'label.name\' | translate }}:</ion-col>\n      <ion-col col-75>{{ user.name }}</ion-col>\n    </ion-row>\n    \n    <ion-row>\n      <ion-col col-25>{{ \'label.email\' | translate }}:</ion-col>\n      <ion-col col-75>{{ user.email }}</ion-col>\n    </ion-row>\n       \n  </ion-card>\n\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"/home/afiliamedica/dev/ionic3-seed-jwt/src/pages/profile-page/profile-page.html"*/,
    }),
