...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile_page__ = __webpack_require__(476);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_speech_recognition__ = __webpack_require__(317);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_text_to_speech__ = __webpack_require__(318);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_core__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_speech_recognition__ = __webpack_require__(317);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_text_to_speech__ = __webpack_require__(318);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_auth_service__ = __webpack_require__(117);
...
var ProfilePage = (function (_super) {
    ...
    function ProfilePage(navCtrl, navParams, menuCtrl, storage, formBuilder, speech, tts, zone, authService) {
        ...
        _this.profileData = _this.formBuilder.group({
            ...
            workPhone: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].required],
            firstname: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].required],
            secondname: ['', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].required]
        });
        return _this;
    }
    ...
    ProfilePage.prototype.hasPermission = function () {
    ...
    ProfilePage.prototype.getPermission = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    ProfilePage.prototype.listenName = function () {
        var _this = this;
        ...
        this.speech.startListening()
            ...
            _this.zone.run(function () {
                ...
                _this.profileData.controls['name'].setValue(matches[0]);
            });
        }, function (error) { return console.error(error); });
    };
    ProfilePage.prototype.listenFirstName = function () {
        var _this = this;
        console.log('listen action triggered');
        if (this.isListening) {
            this.speech.stopListening();
        ...
        this.speech.startListening()
            ...
            _this.zone.run(function () {
                _this.matches = matches;
                _this.profileData.controls['firstname'].setValue(matches[0]);
            });
        }, function (error) { return console.error(error); });
    };
    ProfilePage.prototype.listenSecondName = function () {
        var _this = this;
        console.log('listen action triggered');
        if (this.isListening) {
            this.speech.stopListening();
        ...
        this.speech.startListening()
            ...
            _this.zone.run(function () {
                _this.matches = matches;
                _this.profileData.controls['secondname'].setValue(matches[0]);
            });
        }, function (error) { return console.error(error); });
    };
    ProfilePage.prototype.listenWorkPhone = function () {
        var _this = this;
        console.log('listen action triggered');
        if (this.isListening) {
            this.speech.stopListening();
        ...
        this.speech.startListening()
            ...
            _this.zone.run(function () {
                _this.matches = matches;
                _this.profileData.controls['workPhone'].setValue(matches[0]);
            });
        }, function (error) { return console.error(error); });
    };
    ProfilePage.prototype.toggleListenMode = function () {
...
ProfilePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
        ...
        __WEBPACK_IMPORTED_MODULE_4__angular_forms__["h" /* FormBuilder */],
